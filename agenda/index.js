class AgendaManager {
    ...
    async chargerVueListe() {
        try {
            ...
            // Précisez le conteneur 'listeEvenements'
            this.afficherErreur('listeEvenements', 'Erreur de connexion');
        }
    }
    ...
    async chargerProchainsEvenements() {
        try {
            ...
            console.error('Erreur:', error);
            // Précisez le conteneur 'prochainsEvenements'
            this.afficherErreur('prochainsEvenements', 'Erreur de chargement');
        }
    }
    ...
    afficherListeEvenements(evenements) {
        ...
        //  liste de données d'événements en une série de cartes visuelles
        let html = '';
    ...
    afficherErreur(containerId, message) {
        const container = document.getElementById(containerId);
        // On vérifie que le conteneur existe avant de l'utiliser
        if (container) {
