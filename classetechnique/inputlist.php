...
class InputList extends Input
{
    ...
    // Tableau associatif contenant les options clé => valeur affichée
    ...
    public function checkValidity(): bool
    {
        ...
        if ($this->Value != null) {
            ...
            // Déterminer les valeurs acceptées : soit Options (clés), soit Values
            $valeursAcceptees = !empty($this->Options) ? array_keys($this->Options) : $this->Values;
            
            // La valeur fait-elle partie des valeurs acceptées
            if (!in_array($this->Value, $valeursAcceptees)) {
